...
import org.grapheco.pandadb.neocompat.DatabaseManagementServiceImpl;
...
public class DatabaseManagementServiceFactory
{
    ...
    {
        var homeDir = config.get( GraphDatabaseSettings.neo4j_home);

        DatabaseManagementService managementService = new DatabaseManagementServiceImpl(homeDir.toString());
