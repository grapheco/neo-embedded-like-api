...
//    private final ReadOnlyDatabases readOnlyDatabases;
    ...
    public ModularDatabaseCreationContext( NamedDatabaseId namedDatabaseId, GlobalModule globalModule, Dependencies globalDependencies, Monitors parentMonitors, DatabaseConfig databaseConfig, LeaseService leaseService )
    {
...
//        this.fs = globalModule.getFileSystem();
        this.transactionStats = new DatabaseTransactionStats();
...
//        this.accessCapabilityFactory = editionComponents.getAccessCapabilityFactory();
        ...
        this.startupController = new GlobalAvailabilityGuardController( globalModule.getGlobalAvailabilityGuard() );//editionComponents.getStartupController();
