...
//        this.edition = edition;
    ...
    {
        var dependencies = globalModule.getExternalDependencyResolver();
        var clazz = DatabaseIdRepository.Caching.class;
        return dependencies.containsDependency( clazz ) ? dependencies.resolveDependency( clazz ) : new MapCachingDatabaseIdRepository() ;
    }
    ...
    {
        var db = databaseMap.get( namedDatabaseId );
